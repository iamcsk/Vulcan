...
class CategoriesListContainer extends PureComponent {
...
const options = {
  ...
  queryName: 'CategoriesListContainerQuery',
  fragmentName: 'CategoriesListContainer',
  limit: 0,
  pollInterval: 0,
};

registerComponent('CategoriesListContainer', CategoriesListContainer, withRouter, withApollo, [withList, options]);